      ...
      <el-container>
        ...
        <el-main>
          ...
          >
            ...
            <el-row :gutter="20">
              <el-col :span="2">
                <math-jax3 :formula="'$$堰的类型$$'" />
              </el-col>
              <el-col :span="10">
                <el-select
                  v-model="varepsilonVal"
                  placeholder="请选堰的类型"
                >
                  <el-option
                    v-for="spo in varepsilonOptions"
                    :key="spo.value"
                    :label="spo.label"
                    :value="spo.value"
                  />
            ...
            <el-row :gutter="20">
              <el-col :span="4">
                <math-jax3
                  :formula="'$$上游坝面坡度比 \\Delta y  \\Delta x$$'"
                />
              </el-col>
              <el-col :span="10">
                <el-select
...
import MathJax3 from '@/components/MathJax3/index.vue'
...
export default class Chapter1Section1Sub1 extends Vue {
  ...
  public title = '2.1.1开敞式幂曲线实用堰的泄流能力';
  public initData = {
    n: 4,
    b: 15,
    P_1: 19,
  ...
  @Watch('varepsilonVal')
  public onVarEpsilonValuesChange() {
    this.data['\\varepsilon'] = this.varepsilonVal
  }
  ...
  public formulas = {
    ...
    1: '$$C :上游坡角修正系数$$',
    2: '$$m :流量系数$$',
    3: '$$\\varepsilon :收缩系数,根据闸墩墩头形状及位置、闸墩厚度、闸孔数目、堰上水头及相对堰高等因素选定,设计时对高堰可取\\varepsilon＝0.90\\sim 0.97,均值0.935,对低堰可取\\varepsilon＝0.80\\sim 0.90,均值0.85$$',
    4: '$$b :单孔宽度,m$$',
    5: '$$n :闸孔数目$$',
  ...
  public varepsilonVal = '';
  public varepsilonOptions = [
    {
      label: '高堰',
      value: '0.935'
    },
