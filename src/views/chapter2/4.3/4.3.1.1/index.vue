 ...
 * @LastEditTime: 2022-07-16 21:45:05
 * @FilePath: \hycom_app\src\views\chapter2\4.3\4.3.1.1\index.vue
 * @Description:
...
export default class Chapter3Section2SubSection1 extends Vue {
  ...
  private formulas = {
    ...
    3: '$$\\zeta_k :侧槽溢流堰侧收缩系数,无闸实用堰,两边侧墙圆角到直角取0.7~1.0$$',
    4: '$$H :堰上水头,m,取堰前3H_0~6H_0处$$',
    5: '$$v_0 :引渠的行进流速,m/s$$',
    6: '$$H_0 :计入行进流速的堰上水头,m$$'
  };
